    ...
    <div className="Hero">
      <header className="header">
        ...
        <div className="header__routes">
          <a
            href="https://copyui.com"
            target="_blank"
            rel="noreferre"
            className="header__routes__route header__routes__route--active"
          >
            Inspiration
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferre"
            className="header__routes__route"
          >
            Find Work
          </a>
        ...
        <div className="header__cta">
          <button className="header__cta__button">Sign Up</button>
        </div>

        <div className="header__logo__menubar">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <div className="header__menu">
          <div className="header__menu__links">
            <a
              href="https://copyui.com"
              target="_blank"
              className="header__menu__link header__menu__link--active"
            >
              Inspiration
            </a>
            <a
      ...
      <div className="hero__container">
        <h1>
          Everything
          <div
            className="image__in__text"
            style={{
              backgroundImage: `url('https://cdn.jsdelivr.net/gh/alohe/memojis/png/6437.png')`,
              backgroundColor: "#dad0fc",
            }}
          ></div>
          you need
          <div
            className="image__in__text"
            style={{
              backgroundImage: `url('https://cdn.jsdelivr.net/gh/alohe/memojis/png/5186.png')`,
              backgroundColor: "#fbc2da",
            }}
          ></div>
          to grow your design
          <div
            className="image__in__text"
            style={{
              backgroundImage: `url('https://cdn.jsdelivr.net/gh/alohe/memojis/png/2529.png')`,
